    ...
    def test_entry(self):
        answers = {
            0: {
                ...
                (Paper.rotate, 0): {4: Dim(2, 2), 5: Dim(2, 2), 6: Dim(3, 3)},
                (Paper.rotate, 1): {4: Dim(2, 1), 5: Dim(2, 2), 6: Dim(3, 2)},
                (Paper.rotate, 2): {4: Dim(1, 1), 5: Dim(2, 2), 6: Dim(2, 2)},
                (Paper.rotate, 3): {4: Dim(1, 2), 5: Dim(2, 2), 6: Dim(2, 3)}
        },
            1: {
                (Paper.master, 0): {4: Dim(0, 0), 5: Dim(0, 0), 6: Dim(0, 0)},
                (Paper.sunset, 1): {4: Dim(0, 3), 5: Dim(0, 4), 6: Dim(0, 5)},
                (Paper.vanity, 1): {4: Dim(3, 0), 5: Dim(4, 0), 6: Dim(5, 0)},
                (Paper.mirror, 1): {4: Dim(3, 3), 5: Dim(4, 4), 6: Dim(5, 5)},
                (Paper.rotate, 0): {4: Dim(0, 0), 5: Dim(0, 0), 6: Dim(0, 0)},
                (Paper.rotate, 1): {4: Dim(0, 3), 5: Dim(0, 4), 6: Dim(0, 5)},
                (Paper.rotate, 2): {4: Dim(3, 3), 5: Dim(4, 4), 6: Dim(5, 5)},
                (Paper.rotate, 3): {4: Dim(3, 0), 5: Dim(4, 0), 6: Dim(5, 0)}
        },
            2: {
                (Paper.master, 0): {4: Dim(1, 1), 5: Dim(1, 1), 6: Dim(1, 1)},
                (Paper.sunset, 1): {4: Dim(1, 2), 5: Dim(1, 3), 6: Dim(1, 4)},
                (Paper.vanity, 1): {4: Dim(2, 1), 5: Dim(3, 1), 6: Dim(4, 1)},
                (Paper.mirror, 1): {4: Dim(2, 2), 5: Dim(3, 3), 6: Dim(4, 4)},
                (Paper.rotate, 0): {4: Dim(1, 1), 5: Dim(1, 1), 6: Dim(1, 1)},
                (Paper.rotate, 1): {4: Dim(1, 2), 5: Dim(1, 3), 6: Dim(1, 4)},
                (Paper.rotate, 2): {4: Dim(2, 2), 5: Dim(3, 3), 6: Dim(4, 4)},
                (Paper.rotate, 3): {4: Dim(2, 1), 5: Dim(3, 1), 6: Dim(4, 1)}
        },
            3: {
                (Paper.master, 0): {4: Dim(1, 1), 5: Dim(1, 1), 6: Dim(1, 1)},
                (Paper.sunset, 1): {4: Dim(1, 2), 5: Dim(1, 3), 6: Dim(1, 4)},
            ...
            4: {
                (Paper.master, 0): {4: Dim(2, 2), 5: Dim(2, 2), 6: Dim(2, 2)},
                (Paper.sunset, 1): {4: Dim(2, 1), 5: Dim(2, 2), 6: Dim(2, 3)},
                (Paper.vanity, 1): {4: Dim(1, 2), 5: Dim(2, 2), 6: Dim(3, 2)},
                (Paper.mirror, 1): {4: Dim(1, 1), 5: Dim(2, 2), 6: Dim(3, 3)},
                (Paper.rotate, 0): {4: Dim(2, 2), 5: Dim(2, 2), 6: Dim(2, 2)},
                (Paper.rotate, 1): {4: Dim(2, 1), 5: Dim(2, 2), 6: Dim(2, 3)},
                (Paper.rotate, 2): {4: Dim(1, 1), 5: Dim(2, 2), 6: Dim(3, 3)},
                (Paper.rotate, 3): {4: Dim(1, 2), 5: Dim(2, 2), 6: Dim(3, 2)}
        },
        }

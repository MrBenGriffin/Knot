...
class TestTweak(unittest.TestCase):
    ...
    def test_entry(self):
        answers = {
            ...
            1: {
                (Paper.rotate, 1): {4: Dim(0, 1), 5: Dim(0, 2), 6: Dim(0, 2)},
                ...
                (Paper.rotate, 0): {4: Dim(2, 0), 5: Dim(2, 0), 6: Dim(3, 0)},
                (Paper.rotate, 3): {4: Dim(3, 2), 5: Dim(4, 2), 6: Dim(5, 3)},
                (Paper.rotate, 2): {4: Dim(1, 3), 5: Dim(2, 4), 6: Dim(2, 5)}
            },
            2: {
                ...
                (Paper.rotate, 0): {4: Dim(2, 1), 5: Dim(2, 1), 6: Dim(3, 1)},
                (Paper.rotate, 1): {4: Dim(1, 1), 5: Dim(1, 2), 6: Dim(1, 2)},
                (Paper.rotate, 3): {4: Dim(2, 2), 5: Dim(3, 2), 6: Dim(4, 3)},
                (Paper.rotate, 2): {4: Dim(1, 2), 5: Dim(2, 3), 6: Dim(2, 4)}
            },
            3: {
                (Paper.master, 0): {4: Dim(2, 1), 5: Dim(2, 1), 6: Dim(3, 1)},
                (Paper.sunset, 1): {4: Dim(2, 2), 5: Dim(2, 3), 6: Dim(3, 4)},
            ...
            4: {
                ...
                (Paper.rotate, 0): {4: Dim(2, 2), 5: Dim(2, 2), 6: Dim(3, 2)},
                (Paper.rotate, 1): {4: Dim(2, 1), 5: Dim(2, 2), 6: Dim(2, 2)},
                (Paper.rotate, 3): {4: Dim(1, 2), 5: Dim(2, 2), 6: Dim(3, 3)},
                (Paper.rotate, 2): {4: Dim(1, 1), 5: Dim(2, 2), 6: Dim(2, 3)}
            },
        }

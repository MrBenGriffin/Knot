...
class Cutter:
    ...
    def make(self, wall, cell_dir: Com, cut: Cut = None) -> dict:
        result = {}
        if cut is None:
            ...
            if (self.tweak is Tw.horizon and wall.orientation is Orientation.EW) or \
                    (self.tweak is Tw.vanity and wall.orientation is Orientation.NS):
